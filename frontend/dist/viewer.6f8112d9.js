...
},{}],"inline-selector.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(InlineSelector, [{
    key: "anyOf",
    value: function anyOf(vers) {
      var _this = this;

      return vers.split(',').some(function (version) {
        return _this.vers.has(version);
      });
    }
    /**
     * @returns {boolean}
    ...
    value: function push(el) {
      ...
      (0, _util.vers)(el).split(',').forEach(function (version) {
        return _this2.vers.add(version);
      });
...
},{"./util":"util.js"}],"viewer.js":[function(require,module,exports) {
"use strict";
        ...
        case 5:
          ...
          document.querySelectorAll('.text-wrapper').forEach(function (text) {
            ...
            _toConsumableArray(text.children).forEach(function (child) {
              if (newChildren.length && (0, _util.vers)(last(newChildren)) == (0, _util.vers)(child)) {
            ...
            _toConsumableArray(text.children).forEach(function (child) {
              if (newChildren.length && last(newChildren) instanceof _inlineSelector.default && !last(newChildren).anyOf((0, _util.vers)(child))) {
                last(newChildren).push(child);
              } else if ((0, _util.vers)(root()) == (0, _util.vers)(child)) {
                newChildren.push(child);
              } else {
                var selector = new _inlineSelector.default();
                selector.push(child);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36691" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","viewer.js"], null)
//# sourceMappingURL=/viewer.6f8112d9.js.map